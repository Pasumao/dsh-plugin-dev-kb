...
来源：[`packages/shell/tool-bash-persistent/src/index.ts:400`](https://github.com/deepseek-ai/deepseek-harness/blob/master/packages/shell/tool-bash-persistent/src/index.ts)
